...
export default class Runtime {
    ...
    private internal = new Store<InternalValue>({
        path: '',
        colsId: 0,
        imgId: 0,
        classes: {},
    ...
    public setInternalMemoryItem(name: string, value: InternalValue): InternalValue {
        return this.internal.set(name, value);
    }

    public getInternalMemoryItem(name: string): InternalValue {
        return this.internal.get(name);
    }

    public getInternalMemory(): Store<InternalValue> {
